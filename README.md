...
| --- | --- | --- | --- | --- |
| 2fauth | 2fauth/2fauth | 6.1.1 |  |  |
| actual-server | actualbudget/actual-server | 26.3.0 |  |  |
...
| code-server | linuxserver/code-server | 4.112.0 |  |  |
...
| ghost | ghost | 6.22.1-alpine |  |  |
| ghostfolio | ghostfolio/ghostfolio | 2.249.0 |  |  |
| gitea-mirror | ghcr.io/raylabshq/gitea-mirror | v3.14.0 |  |  |
...
| homarr-v1 | ghcr.io/homarr-labs/homarr | v1.56.1 |  |  |
...
| immich-without-machine-learning | ghcr.io/immich-app/immich-server | v2.6.1 |  |  |
...
| ntfysh | binwiederhier/ntfy | v2.19.2 |  |  |
...
| openclaw | ghcr.io/openclaw/openclaw | 2026.3.13-1 |  |  |
...
| pocketid | ghcr.io/pocket-id/pocket-id | v2.4 |  |  |
| portainer-agent | portainer/agent | 2.39.1 |  |  |
| portainer | portainer/portainer-ce | 2.39.1-alpine |  |  |
...
| speedtest-tracker | linuxserver/speedtest-tracker | 1.13.11 |  |  |
| spoolman | ghcr.io/donkie/spoolman | 0.23.1 |  |  |
| stalwart-mail | stalwartlabs/stalwart | v0.15.5 |  |  |
| stirling-pdf | stirlingtools/stirling-pdf | 2.7.3 |  |  |
...
| trilium | triliumnext/trilium | v0.102.1 |  |  |
