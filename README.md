...
| actual-server | actualbudget/actual-server | 26.5.0 |  |  |
...
| code-server | linuxserver/code-server | 4.117.0 |  |  |
...
| ghost | ghost | 6.35.0-alpine |  |  |
| ghostfolio | ghostfolio/ghostfolio | 2.255.0 |  |  |
| gitea-mirror | ghcr.io/raylabshq/gitea-mirror | v3.15.6 |  |  |
...
| openclaw | ghcr.io/openclaw/openclaw | 2026.4.7-1 |  |  |
...
| passwordpusher-v2 | pglombardo/pwpush | 2.6.3 |  |  |
...
| rocket-chat-v8 | rocket.chat | 8.3.2 |  |  |
...
| stirling-pdf | stirlingtools/stirling-pdf | 2.10.0 |  |  |
