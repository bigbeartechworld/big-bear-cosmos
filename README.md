...
| actual-server | actualbudget/actual-server | 26.4.0 |  |  |
...
| code-server | linuxserver/code-server | 4.116.0 |  |  |
...
| crafty | registry.gitlab.com/crafty-controller/crafty-4 | 4.10.3 |  |  |
...
| ghost | ghost | 6.30.0-alpine |  |  |
| ghostfolio | ghostfolio/ghostfolio | 2.254.0 |  |  |
| gitea-mirror | ghcr.io/raylabshq/gitea-mirror | v3.15.2 |  |  |
| glances | nicolargo/glances | 4.5.3.2-full |  |  |
| gluetun | qmcgaw/gluetun | v3.41.1 |  |  |
| goaway | pommee/goaway | 0.63.14 |  |  |
| gotify | gotify/server | 2.9.1 |  |  |
| guacamole | guacamole/guacamole | 1.6.0 |  |  |
| healthchecks | linuxserver/healthchecks | 4.1.20260323 |  |  |
| homarr-v1 | ghcr.io/homarr-labs/homarr | v1.59.2 |  |  |
...
| linkwarden | ghcr.io/linkwarden/linkwarden | v2.14.0 |  |  |
...
| passwordpusher-v2 | pglombardo/pwpush | 2.4.3 |  |  |
...
| pihole | pihole/pihole | 2026.04.0 |  |  |
...
| pocketid | ghcr.io/pocket-id/pocket-id | v2.5 |  |  |
| portainer-agent | portainer/agent | 2.40.0 |  |  |
| portainer | portainer/portainer-ce | 2.40.0-alpine |  |  |
...
| rocket-chat-v8 | rocket.chat | 8.0.1 |  |  |
...
| stirling-pdf | stirlingtools/stirling-pdf | 2.9.2 |  |  |
...
| umbrel-os | dockurr/umbrel | 1.4.0 |  |  |
| unifi-network-application-mongo-4 | linuxserver/unifi-network-application | 10.1.89 |  |  |
| unifi-network-application | linuxserver/unifi-network-application | 10.1.89 |  |  |
