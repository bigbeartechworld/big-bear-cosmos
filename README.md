...
| actual-server | actualbudget/actual-server | 25.11.0 |  |  |
| adguard-home-host | adguard/adguardhome | 0.107.61 |  |  |
| adguard-home | adguard/adguardhome | v0.107.69 |  |  |
...
| baserow | baserow/baserow | 1.35.3 |  |  |
| beaverhabits | daya0576/beaverhabits | 0.7.4 |  |  |
| beszel | henrygd/beszel | 0.16.1 |  |  |
| big-bear-casaos-user-management | bigbeartechworld/big-bear-casaos-user-management | 0.1.0 |  |  |
| bookstack | lscr.io/linuxserver/bookstack | 25.11.20251109 |  |  |
...
| cloudflared-web | wisdomsky/cloudflared-web | 2025.4.0 |  |  |
| code-server | linuxserver/code-server | 4.106.2 |  |  |
...
| crafty | registry.gitlab.com/crafty-controller/crafty-4 | 4.6.1 |  |  |
| cyberchef | ghcr.io/gchq/cyberchef | 10.19.4 |  |  |
| dashdot | mauricenino/dashdot | 6.2.0 |  |  |
...
| dozzle | amir20/dozzle | v8.14.9 |  |  |
| ejbca-ce | keyfactor/ejbca-ce | 9.1.1 |  |  |
...
| firefox | lscr.io/linuxserver/firefox | 1145.0.2 |  |  |
...
| ghost | ghost | 6.9.1-alpine |  |  |
| ghostfolio | ghostfolio/ghostfolio | 2.219.0 |  |  |
| gitea-mirror | ghcr.io/raylabshq/gitea-mirror | v3.9.2 |  |  |
| gladys | gladysassistant/gladys | 4.57.0 |  |  |
| glances | nicolargo/glances | 4.3.0.8-full |  |  |
| gluetun | qmcgaw/gluetun | v3.40.3 |  |  |
| goaway | pommee/goaway | 0.62.19 |  |  |
| gotify | gotify/server | 2.7.3 |  |  |
| guacamole | guacamole/guacamole | 1.6.0 |  |  |
| healthchecks | linuxserver/healthchecks | 3.12.20251126 |  |  |
| homarr-v1 | ghcr.io/homarr-labs/homarr | v1.44.0 |  |  |
| homarr | ghcr.io/ajnart/homarr | 0.16.0 |  |  |
| home-assistant | ghcr.io/home-assistant/home-assistant | 2025.4.4 |  |  |
...
| immich-without-machine-learning | ghcr.io/immich-app/immich-server | v2.3.1 |  |  |
...
| jlesage-firefox | jlesage/firefox | v25.09.1 |  |  |
| jlesage-handbrake | jlesage/handbrake | v25.10.1 |  |  |
| joplin | joplin/server | 3.4.3 |  |  |
...
| libretranslate | libretranslate/libretranslate | v1.8.0 |  |  |
| linkstack | linkstackorg/linkstack | V4 |  |  |
| linkwarden | ghcr.io/linkwarden/linkwarden | v2.13.1 |  |  |
...
| nextcloud | bigbeartechworld/big-bear-nextcloud-with-smbclient | 0.0.12 |  |  |
| nexterm | germannewsmaker/nexterm | 1.0.5-OPEN-PREVIEW |  |  |
...
| passwordpusher | pglombardo/pwpush | 1.63.5 |  |  |
...
| pihole-unbound | bigbeartechworld/big-bear-pihole-unbound | 2025.11.0 |  |  |
| pihole-updatelists | jacklul/pihole | 2025.11.0 |  |  |
| pihole | pihole/pihole | 2025.11.0 |  |  |
...
| pocketid | ghcr.io/pocket-id/pocket-id | v1.15 |  |  |
| portainer-agent | portainer/agent | 2.36.0 |  |  |
| portainer | portainer/portainer-ce | 2.36.0-alpine |  |  |
...
| romm | rommapp/romm | 4.4.1 |  |  |
| scrutiny | ghcr.io/analogj/scrutiny | master-omnibus |  |  |
| scrypted | koush/scrypted | 0.123.58-jammy-full |  |  |
...
| speedtest-tracker | linuxserver/speedtest-tracker | 1.9.0 |  |  |
| spoolman | ghcr.io/donkie/spoolman | 0.22.1 |  |  |
| stalwart-mail | stalwartlabs/stalwart | v0.14.1 |  |  |
| stirling-pdf | stirlingtools/stirling-pdf | 1.6.0 |  |  |
| syncthing | syncthing/syncthing | 2.0 |  |  |
| tailscale | tailscale/tailscale | v1.90.9 |  |  |
| tandoor | ghcr.io/tandoorrecipes/recipes | 2.3.5 |  |  |
| tianji | moonrailgun/tianji | 1.30.15 |  |  |
| tp-link-omada-controller | mbentley/omada-controller | 5.15 |  |  |
| traccar | traccar/traccar | 6.10-ubuntu |  |  |
| trilium | triliumnext/trilium | v0.99.5 |  |  |
...
| unifi-network-application-mongo-4 | linuxserver/unifi-network-application | 9.5.21 |  |  |
| unifi-network-application | linuxserver/unifi-network-application | 9.5.21 |  |  |
...
| wallos | bellamy/wallos | 4.5.0 |  |  |
| warracker | ghcr.io/sassanix/warracker/main | 9.9.3 |  |  |
| watchyourlan | aceberg/watchyourlan | 2.1.2 |  |  |
