...
| --- | --- | --- | --- | --- |
| 2fauth | 2fauth/2fauth | 6.0.0 |  |  |
| actual-server | actualbudget/actual-server | 26.2.1 |  |  |
| adguard-home | adguard/adguardhome | v0.107.72 |  |  |
...
| baserow | baserow/baserow | 2.1.3 |  |  |
| beaverhabits | daya0576/beaverhabits | 0.9.0 |  |  |
| beszel | henrygd/beszel | 0.18.4 |  |  |
...
| code-server | linuxserver/code-server | 4.109.2 |  |  |
...
| crafty | registry.gitlab.com/crafty-controller/crafty-4 | 4.9.0 |  |  |
| cyberchef | ghcr.io/gchq/cyberchef | 10.22.1 |  |  |
| dashdot | mauricenino/dashdot | 6.3.2 |  |  |
...
| firefox | lscr.io/linuxserver/firefox | 1147.0.4 |  |  |
...
| genmon | bigbeartechworld/big-bear-genmon | 1.19.08 |  |  |
| ghost | ghost | 6.19.3-alpine |  |  |
| ghostfolio | ghostfolio/ghostfolio | 2.243.0 |  |  |
| gitea-mirror | ghcr.io/raylabshq/gitea-mirror | v3.9.6 |  |  |
| glances | nicolargo/glances | 4.5.0.5-full |  |  |
| gluetun | qmcgaw/gluetun | v3.41.1 |  |  |
| goaway | pommee/goaway | 0.63.9 |  |  |
| gotify | gotify/server | 2.9.1 |  |  |
| guacamole | guacamole/guacamole | 1.6.0 |  |  |
| healthchecks | linuxserver/healthchecks | 4.0.20260216 |  |  |
| homarr-v1 | ghcr.io/homarr-labs/homarr | v1.53.2 |  |  |
| homarr | ghcr.io/ajnart/homarr | 0.16.1 |  |  |
| Homepage | ghcr.io/gethomepage/homepage | v1.10.1 |  |  |
| homer | b4bz/homer | v25.11.1 |  |  |
| ihatemoney | ihatemoney/ihatemoney | 7.0.0 |  |  |
| immich-aio-alpine | ghcr.io/imagegenius/immich | 2.0.0-alpine |  |  |
| immich-kiosk | ghcr.io/damongolding/immich-kiosk | 0.33.2 |  |  |
| immich-without-machine-learning | ghcr.io/immich-app/immich-server | v2.5.6 |  |  |
...
| jlesage-firefox | jlesage/firefox | v26.02.3 |  |  |
...
| libretranslate | libretranslate/libretranslate | v1.9.4 |  |  |
| linkstack | linkstackorg/linkstack | V4 |  |  |
| linkwarden | ghcr.io/linkwarden/linkwarden | v2.13.5 |  |  |
...
| mealie | hkotel/mealie | v3.11.0 |  |  |
| microbin | danielszabo99/microbin | 2.1.0 |  |  |
...
| nextcloud | bigbeartechworld/big-bear-nextcloud-with-smbclient | 33.0.0 |  |  |
| nexterm | germannewsmaker/nexterm | 1.0.9-OPEN-PREVIEW |  |  |
| nightscout | nightscout/cgm-remote-monitor | 15.0.4 |  |  |
| nocodb | nocodb/nocodb | 0.301.3 |  |  |
| node-red | nodered/node-red | 4.1.6 |  |  |
| note-mark-aio | ghcr.io/enchant97/note-mark-aio | 0.19.0 |  |  |
| ntfysh | binwiederhier/ntfy | v2.17.0 |  |  |
...
| passwordpusher | pglombardo/pwpush | 1.68.2 |  |  |
...
| pihole-unbound | bigbeartechworld/big-bear-pihole-unbound | 2026.02.0 |  |  |
| pihole-updatelists | jacklul/pihole | 2026.02.0 |  |  |
| pihole | pihole/pihole | 2026.02.0 |  |  |
...
| pocketid | ghcr.io/pocket-id/pocket-id | v2.3 |  |  |
| portainer-agent | portainer/agent | 2.39.0 |  |  |
| portainer | portainer/portainer-ce | 2.39.0-alpine |  |  |
...
| pterodactyl-panel | ghcr.io/pterodactyl/panel | v1.12.1 |  |  |
| pterodactyl-wings | ghcr.io/pterodactyl/wings | v1.12.1 |  |  |
| rallly | lukevella/rallly | 4.7.4 |  |  |
...
| speedtest-tracker | linuxserver/speedtest-tracker | 1.13.10 |  |  |
| spoolman | ghcr.io/donkie/spoolman | 0.23.1 |  |  |
| stalwart-mail | stalwartlabs/stalwart | v0.15.5 |  |  |
| stirling-pdf | stirlingtools/stirling-pdf | 2.5.3 |  |  |
...
| tandoor | ghcr.io/tandoorrecipes/recipes | 2.5.3 |  |  |
| tianji | moonrailgun/tianji | 1.31.13 |  |  |
| traccar | traccar/traccar | 6.12-ubuntu |  |  |
| trilium | triliumnext/trilium | v0.101.3 |  |  |
...
| unifi-network-application-mongo-4 | linuxserver/unifi-network-application | 10.1.85 |  |  |
| unifi-network-application | linuxserver/unifi-network-application | 10.1.85 |  |  |
